...
Fictional SPA test sites (React<sup>[○](#ref-2)</sup>, Vue<sup>[◑](#ref-3)</sup>, Svelte<sup>[◇](#ref-4)</sup>, Solid<sup>[★](#ref-5)</sup>) for benchmarking a future DOM fetcher against known, stable targets. Mirrors the existing L1 suite.
