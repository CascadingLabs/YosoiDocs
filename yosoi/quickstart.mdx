...
<JsonLd schema={{
	...
	mainEntity: [
		...
		},
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "Pass --force (or -F) to the CLI, set YOSOI_FORCE=1, or pass a Policy with ScrapePolicy(force=True). You can also delete the corresponding file from .yosoi/selectors/ and run again.",
			},
		},
		{
			"@type": "Question",
