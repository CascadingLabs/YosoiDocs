...
faqs:
  - q: "Are QScrape sites suitable for production scraping?"
    a: "No. They are fictional test targets designed for evaluation and benchmarking, not for collecting real data."
  - q: "Do QScrape sites ever change their structure?"
    a: "Occasionally, when new difficulty variants or layout scenarios are added. Check the GitHub changelog before relying on a specific selector set in CI."
  - q: "Can I add QScrape to my automated test suite?"
    a: "Yes. Because the sites are stable and purpose-built, they work well as regression targets. Run Yosoi against a QScrape URL in your tests and assert on the extracted field values."
  - q: "What is the difference between L2 and L3 sites?"
    a: "L2 sites add framework complexity (React, Svelte, etc.) but make no attempt to block scrapers. L3 sites actively apply anti-bot techniques such as rate limiting or obfuscated markup."
---
