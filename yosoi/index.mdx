...
The public API is now operation-first: `ys.scrape`, `ys.search`, `ys.crawl`, and `ys.map` share canonical request/result models with the CLI. See [Operations API](/yosoi/operations/) for the machine-readable envelopes and CLI equivalents.
